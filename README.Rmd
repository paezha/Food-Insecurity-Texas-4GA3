...
```{r, include=FALSE}
df_race <- readRDS(glue::glue(here::here(), "/data/df_race.rds"))
```
...
![regression](figures/screenshot.png)
...
cat(readLines(glue::glue(here::here(), "/data/morans_i_test_output.txt")), sep = "\n")
```

![Sem Map Res](figures/sem_r_map.png)
